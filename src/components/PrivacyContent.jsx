...
const PrivacyContent = () => {
    return(
            <> 
                ...
                <Typography variant="body2" component="div" sx={{marginTop:'1rem', opacity:"0.6"}}>
                    Zén Studio built the NotesBay app as a Freemium app. This service is provided by Zén Studio at no cost for basic features and at small chargeable amount for premium features of the app.

                    This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our service.

                    If you choose to use our service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.

                    The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at NotesBay unless otherwise defined in this Privacy Policy. Please take a moment to get to know our practices and contact us if you have any questions.
                </Typography>
                ...
                <Typography variant="body2" component="div" sx={{ opacity:"0.6"}}>
                    ...
                    <br/>Our service also provides in-app subscriptions which are of weekly, monthly and annual tenure called NotesBay-PRO. The AI Writing Assistant feature of the app comes at a limited usage of 10 prompts on our free plan. Users need to subscribe to the NotesBay-PRO subscription in order to increase their access count to an unprecedented high number for the AI Writing Assistant feature.
                </Typography>
